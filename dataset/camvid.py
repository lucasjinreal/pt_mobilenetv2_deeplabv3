...
class CamVid(data.Dataset):
    ...
    def __init__(self,
        ...
        if self.mode.lower() == 'train':
            # Get the training dataset and labels filepaths
            ...
            # Get the validation dataset and labels filepaths
            ...
            # Get the test dataset and labels filepaths
